...
module.exports =
{
    ...
    insert: async function(req,res) {
        ...
        if (validasi.errors.length > 0) {
            return res.render('stok-keluar/main', {
                req: req,
                produk: await m_produk.get_semua_produk(),
        ...
        try {
            ...
            res.redirect('/stok-keluar?error_msg=' + objek_error)
        }
    }
